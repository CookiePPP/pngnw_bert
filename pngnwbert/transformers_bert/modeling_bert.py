...
# the original code can be found at https://github.com/huggingface/transformers/blob/main/src/transformers/models/bert/modeling_bert.py
...
class BertPreTrainedModel(nn.Module):
    ...
    def get_extended_attention_mask(
        self, attention_mask: Tensor, input_shape: Tuple[int], device = None
    ) -> Tensor:
        """
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        input_shape = input_char_ids.size()

        batch_size, seq_length = input_shape
        device = input_char_ids.device
